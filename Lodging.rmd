...
,38897,38886,38888,38887,38901,22706,36823,36814,46880,167081,27560,1289900,26613,26621,27588,46193,51883,51233,45842,18650,42696
...
write_xlsx(df_lodging,here::here("output", "df_final_lodging.xlsx"))
saveRDS(df_lodging,here::here("output", "df_final_lodging.rds"))
...
Download cleaned data: [here](https://mccsorg-my.sharepoint.com/:x:/g/personal/jason_barnes_usmc-mccs_org/EX4Vdz_H-7tMkHUU2mg_1A4B_r5IUUc4mTZTyR7GGWHi0Q?e=swZIdx)
