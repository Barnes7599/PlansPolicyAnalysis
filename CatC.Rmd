...
title: |
  ...
  ![](images/MCCSlogo_Comp.png){width=2in}  

  Category C Profit vs Utilization Report  

author: 

  - MCCS PPBEA WG ^[Jason Barnes (MR), Jeff Capellini (MF), Ed Cutshall (MCIOM), Doug Campbell (MCICOM)]
