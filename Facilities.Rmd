...
cat_code <- read_xlsx(path = "data/MCCS_Facility_Inventory_Report.XLSX",
    sheet = "Cat_code",
...
fac <-  read_xlsx(path = "data/MCCS Facility Inventory Report - 2021-09-28_14-56-08.XLSX",
    sheet = "Facility",
    skip = 1,
    col_types = c(
      "text", "text", "text",
...
utl <-  read_xlsx("data/MCCS Facility Inventory Report - 2021-09-28_14-56-08.XLSX",
    sheet = "Utilization",
    skip = 1
  )
...
write_xlsx(df_final,here::here("output", "df_final.xlsx"))
saveRDS(df_final,here::here("output", "df_final.rds"))
