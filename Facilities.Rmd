...
saveRDS(
  read_xlsx(here::here("data/", "MCCS_Facility_ Inventory_Report.XLSX"),
    sheet = "Cat_code",
    col_types = c("numeric", "text", "text", "text"
    )
  ),
  here::here("data", "Cat_code.rds")
)
...
df_final <- df_clean %>%
  select(region, installation = installation.y, RPUID, use_code, use_desc, fac_use, naf_cat, op_activity, fac_num, facility_desc, asset_name, fci, fci_dt, q_rating, total_measure, alt_total_measure, other_total_measure, other_unit_measure, fac_area_measure, prv,sus, RM, use_pct_area, RM_corrected)
