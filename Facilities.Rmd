...
program_decade_sqft <- df_final %>%
  ...
  labs(
    ...
    x = "Decade",
    title = "What is the trend of sqft additions by Program?",
    subtitle = "Decade is based on iNFADS facility build date*",
    caption = "*Build dates are grouped by decade (ex. 2010-2019) is decade 2010"
  )
