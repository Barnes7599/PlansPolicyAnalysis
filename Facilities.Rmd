...
cost_by_Program_DT <- df_final %>%
  ...
  group_by(installation, naf_cat, op_activity, use_desc, asset_name) %>%
...
##### What is the average cost per square foot utilization by Program?
...
##### What is the average costs per squre foot utilization by Region? 

Locations without a Region have substainally greater costs for FSRM per squre foot utilization. 
