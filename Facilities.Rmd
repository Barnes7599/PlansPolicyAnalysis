...
-If outliers are present, the whisker on the appropriate side is drawn to 1.5 * IQR rather than the data minimum or the data maximum. Red filled circles are used for known outliers.

-Widths of the boxplot are represented of the amount of observations within each grouping. 
...
q_box <- q_group %>% 
  ...
  geom_boxplot(outlier.color = "red",varwidth = TRUE, outlier.alpha = .5, fill = "#2c3e50", alpha = .5) +
