...
utl <- utl %>%
  ...
  filter(RPUID %notin% c(
    ...
    26613,26621,27588,46193,51883,51233,45842,18650,42696,42695,40527,52004,53326,40533,40523,40525,40531,
...
fac_mapped <- fac_mapped %>%
  ...
  #Adding Klipper villas and building Q11 and 185 in Barstow to Rec Lodging Cat C
   mutate(naf_cat = if_else(RPUID %in% c(25898, 25895, 25897, 25896, 25899, 32935, 32790),"C", naf_cat)) %>% 
