...
# ------------- Join Utilization data with NAF Category Codes --------------

fac_mapped <- utl %>%
  inner_join(cat_code, by = c("use_code" = "use_code"))

#------------- Join Utilization/Cat Code with Facility Data ---------------
...
Download cleaned data: [here](https://mccsusmc-my.sharepoint.us/:x:/g/personal/jason_barnes_usmc-mccs_org/EQrwUKqfK4lKsz_7EKWl4e4Bg_cT1VSOBhd-YhD5RfUFTA?e=K4XbAT)
