...
##### What is the trend of sqft additions by Program?
...
##### Additional Square Footage by Decade
...
##### Cumulative New Sqare Footage by Decade
...
##### What is the percent of total square foot by Category?
...
Cateory C accounts for **`r pct_c_sqft`** of MCCS total utilization. 
...
##### What is the FSRM cost per square foot by Category?
...
avg_sqft_cat <- df_final %>% 
  ...
  gt() %>% 
   tab_header(
  title = md("FSRM SqFt Costs by Category"),
  subtitle = md("*iNFADS* data retrieved **Jun 17, 2021**")
) %>% 
  fmt_currency(
...
##### What is percent of total square foot by Program?
...
##### What is the average cost per square foot by Program?
...
avg_cost_sqft_program <- df_final %>% 
  ...
  gt() %>% 
   tab_header(
  title = md("FSRM SqFt Costs by Program"),
  subtitle = md("*iNFADS* data retrieved **Jun 17, 2021**")
) %>% 
  fmt_currency(
    columns = c(avg_fsrm_cost),
...
##### What is the percent of total sqft by Region?
...
##### What is the average costs per squre foot by Region? 

Locations without a Region have a substainally greater costs for FSRM per squre foot. 
...
cost_sqft_region <- df_final %>% 
  ...
  gt() %>% 
   tab_header(
  title = md("FSRM SqFt Costs by Region"),
  subtitle = md("*iNFADS* data retrieved **Jun 17, 2021**")
) %>% 
  fmt_currency(
    columns = c(avg_fsrm_cost),
...
##### What is the percent of total sqft by Installation? 
...
installation_sqft_pct_table <- df_final %>%
  ...
  gt()  %>% 
  tab_header(
  title = md("Top 10 Installations based on total sqaure feet of facilities aboard the Installation"),
  subtitle = md("*iNFADS* data retrieved **Jun 17, 2021**")
) %>% 
  fmt_number(
    columns = c(total),
...
MCCS has facilities in 26 different locations. The below grpah breaks down the percent of total square foot utilization by each location. 
