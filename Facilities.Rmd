...
__use_desc:__ The title of the use category associated with the Category Use Code (use_code) derived from the Appendix A - Category Codes for Navy and Marine Corps Real Property Replacement for NAVFAC P72. [source](https://www.wbdg.org/ffc/dod/unified-facilities-criteria-ufc/ufc-2-000-05n) 
...
>The calculation in this report for Cat C utilizations is 2x iNFADS (FSM calculated Sustainment costs, for Cat A, Cat B and Lodging utilizations (FSM calculated sustainment costs)
...
>The calculation in this report is based on 2.5% of the facilities Plant Replacement Value (PRV), this calculation assumes facility is fully recapitalizaed and that sustainment costs are being applied annualy to each facility.
...
Additional References: [source](https://www.navfac.navy.mil/products_and_services/am/about_us/resources.html)
